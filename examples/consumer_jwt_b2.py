"""Example: Run the B2 JWT bundle using the JWT example plugin pack.
...
and the jwt_example plugin pack.
"""
...
def main() -> None:
    ...
    print("JWT plugin registry contents:")
    ...
    # -- Run B2 through the conformance harness --
    corpus = load_corpus_from_default()
    case = corpus.get_case("B2")
    if case is None:
        print("\nCase B2 not found in corpus.")
        return
